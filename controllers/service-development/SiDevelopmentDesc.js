import Desc from "../../model/service-development/SiDevelopmentDesc.js";
...
export const createDesc = async (req, res) => {
    try {
        ...
        const imagePath = `/uploads/si-slider-information/${req.file.filename}`;
...
export const updateDesc = async (req, res) => {
    try {
        ...
        if (req.file) {
            ...
            imagePath = `/uploads/si-slider-information/${req.file.filename}`;
        }
