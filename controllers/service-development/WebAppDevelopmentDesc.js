import Desc from "../../model/service-development/WebAppDevelopmentDesc.js";
...
export const createDesc = async (req, res) => {
    ...
    //     const imagePath = `/uploads/web-slider-information/${req.file.filename}`;
...
export const updateDesc = async (req, res) => {
    try {
        ...
        if (req.file) {
            ...
            imagePath = `/uploads/web-slider-information/${req.file.filename}`;
        }
