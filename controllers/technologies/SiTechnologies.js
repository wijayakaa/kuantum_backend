import Technologies from "../../model/technologies/SiTechnologies.js";
...
export const createTechnologies = async (req, res) => {
    try {
        ...
        const logoPath = req.file
            ? `/uploads/si-technologies/${req.file.filename}`
            : null;
...
export const updateTechnologies = async (req, res) => {
    try {
        ...
        if (req.file) {
            ...
            logoPath = `/uploads/si-technologies/${req.file.filename}`;
        }
